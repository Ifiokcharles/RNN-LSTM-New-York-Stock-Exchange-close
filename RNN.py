...
training_set_scaled = sc.fit_transform(close_dataset)
...
dataset_test = pd.read_csv('prices-split-adjusted.csv' ,nrows=20)
real_stock_price = dataset_test.iloc[:,2:3].values

# Getting the predicted stock price of 2017
dataset_total = pd.concat((dataset['close'], dataset_test ['close']), axis = 0) #axis=0 is vertical concat
...
plt.plot(real_stock_price, color = 'red', label = 'Real New York Price')
